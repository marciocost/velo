...
const Success = () => {
  ...
  const isRejected = order.status === 'REPROVADO' || (!isApproved && !isAnalysis);
      ...
      <div className="w-full max-w-2xl bg-card rounded-lg shadow-elegant-lg p-8 animate-scale-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            ...
            {isAnalysis && 'Seu pedido está em análise de crédito. Acompanhe o status na consulta de pedidos.'}
            {isRejected && 'Infelizmente seu crédito não foi aprovado. Tente novamente com pagamento à vista.'}
          </p>
        </div>
